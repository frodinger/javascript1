...
and consider the "returns" column of each example. 
That's the key to which way the if-statement will go.
...
/*
Task 1:
    Below is a variable which stores the word count of a blog post I'm writing.
...
/*
Task 2:
    Use the "and" logical operator (&&) to chain two assertions together. Below are two
...
/*
Task 3:
    Using .length() to get the length of a string and the `name` variable below,
