...
/*
Task 3:
    Write a function called `printGreeting`. When invoked using the examples
...
/*
Task 4:
    Write a function called `multiply` which multiplies two numbers together and returns the value
...
/*
Task 5:
    Write a function called `warmEnough` which takes the current temperature
    as an argument and returns `true` if it is greater than 10 and false otherwise.
    Comment out the code below to invoke the function. It should print "Go for a run!"
*/

function warmEnough(num) {
    if (num >= 10) {
        return true;
    } else {
        return false;
